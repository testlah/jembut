...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            CODED BY: IQBALZ NOOBS           |"
    print GL+"  |       Gunakan denggan bijak budjank         |"
    print WW+"  |            EDITTED:  BY EXTAZY              |"
    print Y+"   |         Hargai Karya Orang Lain Goblok      |"
    print GL+"  |---------------------------------------------|"
...
print wd+"         https://github.com/testlah "
